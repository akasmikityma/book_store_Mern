    ...
    <div>
       <table className='w-full border-separate border-spacing-2'>
                <thead>
                     ...
                     <th className='border border-slate-600 rounded-md max-md:hidden'>publish_year</th>
                ...
                {books.map((book, index) => {
                        return (
                            <tr key={book._id} className='h-8'>
                                ...
                                <td className='border border-slate-700 rounded-md text-center'>{book.publish_year}</td>
